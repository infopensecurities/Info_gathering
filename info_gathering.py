...
argparse = argparse.ArgumentParser(description="This is a Basic infogather tool.", usage="python3 info_gathering.py -d DOMAIN [-s IP]")
...
if ip:
    ...
    # shodan API
    api = shodan.Shodan("61TvA2dNwxNxmWziZxKzR5aO9tFD00Nj")
    try:
